...
def annotate_candidate_loci_with_mei(
    ...
    if reuse_dir is not None:
        ...
        remap_t0 = time.monotonic()
        # Index the shared MEI panel once before any remaps. Parallel workers
        # calling bwa index on the same FASTA can SIGSEGV.
        click.echo("[mei-annotate] ensuring MEI panel bwa index before remaps")
